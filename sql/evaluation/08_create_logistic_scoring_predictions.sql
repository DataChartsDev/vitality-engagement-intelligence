...
OPTIONS (
    description = 'Risk scores for the unlabelled final seven-day scoring period.'
)
AS
WITH predictions AS (
    SELECT *
...
SELECT
    ...
    predicted_probability >= 0.467 AS predicted_high_risk
FROM positive_probabilities;
